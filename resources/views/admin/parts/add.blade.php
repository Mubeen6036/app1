...
<form method="POST" action="{{ url('parts/store') }}" class="form-horizontal">
	{{csrf_field()}}
	<div class="row small-spacing">
		...
		<div class="col-lg-6 col-xs-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
				<input type="text" name="name"  autocomplete="off" class="form-control" value="" placeholder="Type Name" required>
				</div>
			</div>
		</div>
		<div class="col-lg-6 col-xs-12">
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<h6 class="m-0 font-weight-bold">Manufacture Date : </h6>
				</div>
				<div class="card-body">
